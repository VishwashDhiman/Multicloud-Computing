...
[
  {
    "image": "docker.io/vishwash-dhiman/aws_app:1.0",
    "cpu": 1024,
    "memory": 2048,
    "name": "udacity-app",
    "networkMode": "awsvpc",
    "environment": [
      {
        ...
        "value": "udacity-vishwash-dhiman-azure-sql"
      },
      {
        "name": "AZURE_DOTNET_APP",
        "value": "udacity-vishwash-dhiman-azure-dotnet-app"
      }
    ],
    "portMappings": [
      {
...
resource "aws_s3_bucket" "b" {
  bucket = "udacity-vishwash-dhiman-aws-s3-bucket"
